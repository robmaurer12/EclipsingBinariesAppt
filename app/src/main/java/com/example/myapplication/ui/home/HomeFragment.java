...
import static com.example.myapplication.MyStarsClass.getJulianDate;
...
import com.example.myapplication.MyStarsClass;
import com.example.myapplication.Stars;
import com.example.myapplication.TimeClasses;
        ...
        findStarsButton.setOnClickListener(v -> {
            ...
            if (decValue.isEmpty()) {
                ...
                if (decdegreeSwitch.isChecked()) {
                    ...
                    Log.e("MyStarsClass", "Invalid "+ decValuedecimal);
                }
            }
            if (raValue.isEmpty()) {
            ...
            Log.e("MyStarsClass", "ra "+ raValuedecimal + "dec " + decValuedecimal);
